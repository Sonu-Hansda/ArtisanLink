    ...
    return (
        <div className="container" style={{ padding: '120px 20px', minHeight: '60vh' }}>
            ...
            <div style={{ marginTop: '40px', color: 'var(--text-secondary)', lineHeight: '1.6' }}>
                <p>Welcome to Cross Origin Labs. By accessing our website, you agree to be bound by these Terms of Service.</p>
                ...
                <p>All content on this website is the property of Cross Origin Labs unless otherwise stated.</p>
            </div>
        </div>
    );
};
